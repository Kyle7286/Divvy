...
function StatCard(props) {
    return (
        <div tag="a" onClick={props.handleClick} data-vl={props.title} id={props.title} data-type="Status" style={{ cursor: "pointer" }} className=" card col-2 mx-3 shadow mb-2 text-center float-left px-0" data-component="employeecard">
